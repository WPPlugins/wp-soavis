...
class WP_SoaVis_Public {
	...
	/**
	 * Filter allowing users to change post fields before post gets created
	 *
	 */
	public function wps_gform_post_data($post_data, $form, $entry) {

		if (isset($post_data['post_content'])) {
			$post_data['post_content'] = $this->wps_decode_shortcode($post_data['post_content']);
		}
		return $post_data;
	}
	 ...
	 *
	 */
	public function wps_decode_shortcode($value) {

		$find = array( '&#91;SoaVis_Graph&#93;' );
		$replace = array( '[SoaVis_Graph]' );
