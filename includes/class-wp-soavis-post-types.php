	...
	protected function wps_define_post_types() {
		$this->post_types = array(
			'soavis_service' => array(
				'slug'                => 'soavis_service',
				'name'                => __( 'Services', 'wp-soavis' ),
				'singular_name'       => __( 'Service',  'wp-soavis' ),
				'menu_icon'           => 'dashicons-share-alt',
			),
			'soavis_component' => array(
				'slug'                => 'soavis_component',
				'name'                => __( 'Components', 'wp-soavis' ),
				'singular_name'       => __( 'Component',  'wp-soavis' ),
				'menu_icon'           => 'dashicons-networking',
			),
			'soavis_system' => array(
				'slug'                => 'soavis_system',
				'name'                => __( 'Systems', 'wp-soavis' ),
				'singular_name'       => __( 'System',  'wp-soavis' ),
				'menu_icon'           => 'dashicons-analytics',
			),
			'soavis_project' => array(
				'slug'                => 'soavis_project',
				'name'                => __( 'Projects', 'wp-soavis' ),
				'singular_name'       => __( 'Project',  'wp-soavis' ),
				'menu_icon'           => 'dashicons-analytics',
			),
			'soavis_chain' => array(
				'slug'                => 'soavis_chain',
				'name'                => __( 'Chains', 'wp-soavis' ),
				'singular_name'       => __( 'Chain',  'wp-soavis' ),
		...
		foreach ($this->post_types as $cur_post_type) {
			...
			$post_type_args = array(
				'labels' => array(
					...
					'add_new'             => __( 'Add New', 'wp-soavis' ),
					'add_new_item'        => sprintf(__( 'Add New %s', 'wp-soavis' ), $cur_post_type['singular_name']),
					'edit_item'           => sprintf(__( 'Edit %s', 'wp-soavis' ), $cur_post_type['singular_name']),
					'new_item'            => sprintf(__( 'New %s', 'wp-soavis' ), $cur_post_type['singular_name']),
					'view_item'           => sprintf(__( 'View %s', 'wp-soavis' ), $cur_post_type['singular_name']),
					'search_item'         => sprintf(__( 'Search %s', 'wp-soavis' ), $cur_post_type['name']),
					'not_found'           => sprintf(__( 'No %s found', 'wp-soavis' ), $cur_post_type['name']),
					'not_found_in_trash'  => sprintf(__( 'No %s found in trash', 'wp-soavis' ), $cur_post_type['name']),
					'all_items'           => sprintf(__( 'SoaVis %s', 'wp-soavis' ), $cur_post_type['name']),
				),
				'public'            => true,
				'show_ui'           => true,
				...
				// Adding support for WP REST API
				'show_in_rest'      => true,
				'rest_base'         => $cur_post_type['slug'],
			);
