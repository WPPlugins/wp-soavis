 ...
 * @copyright  2015 - 2017 De B.A.A.T.
 */
...
class WP_SoaVis_Shortcodes {
	...
	public function __construct( $main_plugin ) {
		...
		// Set some variables
		$this->menu_title = __('WP SoaVis Shortcodes', 'wp-soavis');
...
//        add_filter('add_wp_soavis_menu_items',array($this,'add_menu_items'),90);
	...
	function wps_define_shortcodes() {
		$this->shortcodes = array(
			'soavis_graph' => array(
				'label'       => 'SoaVis_Graph',
				'description' => __('The shortcode to render a graph of service dependencies specified in the DOT language.', 'wp-soavis') . ' ' .
									__('By default, this shortcode shows the dependencies of the current post.', 'wp-soavis') . ' ' .
									__('If the current post is a service, this shortcode shows the dependencies of this current service.', 'wp-soavis') . ' ' .
									__('For any other post type, this shortcode shows the dependencies of this current post.', 'wp-soavis') . ' ',
				'class'       => $this,
				'function'    => 'wp_soavis_graph_shortcode',
				'parameters'  => '<ul>' .
									'<li>' .
									'<strong>title</strong>="' . __('Title text', 'wp-soavis') . '"' .
									'<br/>' .
									__('A text string that is used as title for this list.', 'wp-soavis') . ' ' .
									__('Default value is Dependencies Graph.', 'wp-soavis') .
									'</li>' .
									'<li>' .
									'<strong>alignment</strong>="&lt;slug&gt;"' .
									'<br/>' .
									__('Determines the location of the box, similar to the alignment of media.', 'wp-soavis') . ' ' .
									__('Valid values are:', 'wp-soavis') . ' ' .
									'<code>none</code>, <code>left</code>, <code>center</code>, <code>right</code>.' . ' ' .
									__('Default value is:', 'wp-soavis') . ' ' .
									'<code>left</code>.' . ' ' .
									'</li>' .
									'<li>' .
									'<strong>start_nodes</strong>="&lt;ID&gt;,&lt;Title&gt;"' .
									'<br/>' .
									__('With this value, a list can be defined to be used as starting point for the graph tree.', 'wp-soavis') . ' ' .
									__('The value should be a comma separated list of post IDs or titles.', 'wp-soavis') . ' ' .
									__('Default value is empty, using the current post as starting node.', 'wp-soavis') . ' ' .
									'</li>' .
									'<li>' .
									'<strong>show_list</strong>="&lt;slug&gt;"' .
									'<br/>' .
									__('Determines whether to show a list of dependencies.', 'wp-soavis') . ' ' .
									sprintf(__('Default value is: %s, showing NO list.', 'wp-soavis'), '<code>NO</code>') . ' ' .
									__('Any other value will show a list.', 'wp-soavis') . ' ' .
									'</li>' .
								 '</ul>',
			),
			'soavis_list' => array(
				'label'       => 'SoaVis_List',
				'description' => __('The shortcode to render a list of SoaVis entities, optionally filtered.', 'wp-soavis'),
				'class'       => $this,
				...
				'parameters'  => '<ul>' .
									...
									'<br/>' .
									sprintf(__('The %s of the SoaVis type to show.', 'wp-soavis'), '<code>slug</code>') . ' ' .
									__('Valid values are:', 'wp-soavis') . ' ' .
									'<code>Service</code>, <code>Project</code>, <code>System</code>, <code>Chain</code>, <code>Component</code>.' . ' ' .
									__('Default value is:', 'wp-soavis') . ' ' .
									'<code>Service</code>.' . ' ' .
									'</li>' .
									'<li>' .
									...
									'<br/>' .
									__('A text string that is used as title for this list.', 'wp-soavis') . ' ' .
									__('Default value is empty, thus showing no title.', 'wp-soavis') . ' ' .
									'</li>' .
									'<li>' .
									'<strong>filter</strong>="&lt;key=value;&gt;"' .
									'<br/>' .
									__('A set of parameters that can be used to filter the list.', 'wp-soavis') . ' ' .
									sprintf(__('The parameter value must be a set of [%s] pairs.', 'wp-soavis'),'<code>&lt;key=value;&gt;</code>') . ' ' .
									sprintf(__('Sets need to be separated by the "%s" character.', 'wp-soavis'),'<code>;</code>') . ' ' .
									sprintf(__('The texts for %s and %s need to be separated by the "%s" character.', 'wp-soavis'),'<code>key</code>','<code>value</code>','<code>=</code>') . ' ' .
									sprintf(__('The %s will be matched with a meta_key as stored with a post, e.g. the value "Document" will match with meta_key "RelatedDocument".', 'wp-soavis'),'<code>key</code>') . ' ' .
									sprintf(__('The %s will be matched as a LIKE with the meta_value related to the meta_key found for the corresponding %s.', 'wp-soavis'),'<code>value</code>','<code>key</code>') . ' ' .
									__('When multiple pairs are defined, only entities will be found that match ALL filter pairs.', 'wp-soavis') . ' ' .
									'</li>' .
									'<li>' .
									'<strong>search</strong>="&lt;text&gt;"' .
									'<br/>' .
									__('A parameter that can be used to search the entities requested.', 'wp-soavis') . ' ' .
									__('The parameter value must be a text string.', 'wp-soavis') . ' ' .
									'</li>' .
									'<li>' .
									'<strong>show_number</strong>="&lt;text&gt;"' .
									'<br/>' .
									__('A parameter that determines whether or not to show the number of entities found.', 'wp-soavis') . ' ' .
									sprintf(__('If the value of %s is %s, the number is not shown; any other value will show the number.', 'wp-soavis'), '<code>&lt;text&gt;</code>', '<code>NO</code>') . ' ' .
									__('Default value is empty, thus showing the number.', 'wp-soavis') . ' ' .
									'</li>' .
								 '</ul>',
			),
			'soavis_dependencies' => array(
				'label'       => 'SoaVis_Dependencies',
				'description' => __('Renders a list of services this entity dependends on.', 'wp-soavis'),
				'class'       => $this,
				...
				'parameters'  => '<ul>' .
									...
									'<br/>' .
									__('A text string that is used as title for this list.', 'wp-soavis') . ' ' .
									__('Default value is Dependencies.', 'wp-soavis') . ' ' .
									'</li>' .
									'<li>' .
									'<strong>alignment</strong>="&lt;slug&gt;"' .
									'<br/>' .
			...
			'soavis_dependencies_up' => array(
				...
				'description' => __('Renders a list of services that depend on this service.', 'wp-soavis'),
				'class'       => $this,
			...
			'soavis_info_box' => array(
				...
				'description' => __('Renders a box with information.', 'wp-soavis'),
				'class'       => $this,
				...
				'parameters'  => '<ul>' .
									...
									'<br/>' .
									__('A text string that is used as title for this list.', 'wp-soavis') . ' ' .
									__('Default value is Info Box.', 'wp-soavis') . ' ' .
									'</li>' .
									'<li>' .
									'<strong>alignment</strong>="&lt;slug&gt;"' .
									'<br/>' .
			...
			'soavis_references' => array(
				...
				'description' => __('Renders a list of references.', 'wp-soavis'),
				'class'       => $this,
				...
				'parameters'  => '<ul>' .
									...
									'<br/>' .
									__('A text string that is used as title for this list.', 'wp-soavis') . ' ' .
									__('Default value is References.', 'wp-soavis') . ' ' .
									'</li>' .
									'<li>' .
									'<strong>alignment</strong>="&lt;slug&gt;"' .
									'<br/>' .
	...
	function wp_soavis_graph_shortcode($attr, $content) {
		...
		$wps_atts = shortcode_atts(array(
			'title'       => __('Dependencies Graph', 'wp-soavis'),
			'alignment'   => 'left',
			'start_nodes' => '',
			'show_list'   => 'NO',
			'show_text'   => 'NO',
		...
		if ($wps_atts['title']) {
			$wps_shortcode_output_list .= '<h2>' . __('Graph Dependencies List', 'wp-soavis') . '</h2>';
		}

		// Generate the info box itself
		if (!$wps_post) {
			$wps_shortcode_output_list .= __('No dependencies found.', 'wp-soavis');
		} else {
...
//						$ref_post = get_page_by_title($ref_title, 'OBJECT', 'soavis_service');
		...
		$wps_graphviz_input   = '';
		$wps_graphviz_input  .= '[WP_GraphViz type="digraph" simple=true]';
		...
		if ($wps_atts['show_text'] != 'NO') {
			...
			$wps_shortcode_output .= '<h3>' . __('Graph Dependencies Text', 'wp-soavis') . '</h3>';
	...
	function wp_soavis_dependencies_shortcode($attr, $content) {
		...
		// Get the shortcode_attributes
		$wps_atts = shortcode_atts(array(
			'title'       => __('Dependencies', 'wp-soavis'),
			'alignment'   => 'left',
		), $attr);
		...
		// Generate the info box itself
		if (!$wps_post) {
			$wps_shortcode_output .= __('No dependencies found.', 'wp-soavis');
		} else {
...
//						$ref_post = get_page_by_title($ref_title, 'OBJECT', 'soavis_service');
	...
	function wp_soavis_dependencies_up_shortcode($attr, $content) {
		...
		// Get the shortcode_attributes
		$wps_atts = shortcode_atts(array(
			'title'       => __('Dependencies Up', 'wp-soavis'),
			'alignment'   => 'left',
		), $attr);
...
//						$ref_post = get_page_by_title($ref_title, 'OBJECT', 'soavis_service');
	...
	function wp_soavis_references_shortcode($attr, $content) {
		...
		// Generate the info box itself
		if (!$wps_post) {
			$wps_shortcode_output .= __('No references found.', 'wp-soavis');
		} else {
	...
	function wp_soavis_info_box_shortcode($attr, $content) {
		...
		// Generate the info box itself
		if (!$wps_post) {
			$wps_shortcode_output .= __('No post found.', 'wp-soavis');
		} else {
			$this->debugMP('pr',__FUNCTION__ . ' wps_post', $wps_post);
	...
	function wp_soavis_list_shortcode($attr, $content) {
		...
		if ($wps_atts['show_number'] != 'NO') {
			$wps_shortcode_output .= sprintf(__(' Number of <strong>%s</strong> found = %d.<br/>', 'wp-soavis'), $wps_type_string, count($wps_posts));
		}
	...
	public function wps_generate_soavis_list( $wps_posts, $type = '' ) {
		...
		if (!$wps_posts || (count($wps_posts) == 0)) {
			...
			$wps_list_output .= sprintf(__(' No <strong>%s</strong> found for type %s.<br/>', 'wp-soavis'), $wps_type_string, $type);
		} else {
	...
	public function wps_generate_soavis_list_header() {
		...
		if ((count($this->post_type_fields) == 0)) {
			$wps_list_output .= __('No header information to display.', 'wp-soavis');
		} else {
	...
	public function wps_generate_soavis_list_row( $cur_post ) {
		...
		// Check number of posts found and generate display accordingly
		if ((count($this->post_type_fields) == 0)) {
			$wps_list_output .= sprintf(__('No information to display for post %s.', 'wp-soavis'), $cur_post->ID);
		} else {
